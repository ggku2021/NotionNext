const CONFIG = {
  ...
  HEXO_HOME_BANNER_GREETINGS: ['Hi，Congratulations, you have found a Chinese footwear supplier website that specializes in supplying the global market.🎉'], // 首页大图标语文字
